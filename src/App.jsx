...
function App() {
  ...
  return (
    <div>
      <div className="overflow-y: auto max-lg::w-full max-lg:w-full w-full ">
        <NavBar />
        <div className="w-2/3 h-4/5  mx-auto my-14 overflow-y: auto lg:text-sm max-lg:mx-0 max-lg:w-3/4">
          <Heading />
          <div className="absolute  items-center w-full  -ml-56 ">
            <Input />
            <div className="ml-28 max-lg:ml-8 max-sm:ml-64 flex flex-row ">
              <button
                className={
                  "" +
                  (!isCompleteScreen
            ...
            <div className=" w-11/12  rounded mb-3 overflow-hidden max-sm:ml-60  max-lg:ml-16  ml-14">
